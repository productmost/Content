|Property|Value|
|--------|-----|
|Name|Alcatel One Touch S'POP 4030
|Price|
|Launched|
...
|CPU Cores|1
|CPU Model|`MediaTek MT6575`
|CPU Clock Rate|1000 MHz
|Graphics Processor Unit|`PowerVR SGX531`
...
|Run Time in Idle Mode|254 h
|Battery Mount Type|`Removable`
|Speaking Run Time|0.1 h
...
|Specific Absorption Rate|0.86 W/kg
|Changeable Parts|`No`
|Buttons|
|Vibration|`Yes`
|Flashlight|`No`
