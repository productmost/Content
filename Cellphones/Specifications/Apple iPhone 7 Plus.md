...
|Property| Value |
|--------|-------|
|Color|`Gold` `Pink` `Black` `Silver`
|Memory|256 GB;128 GB;32 GB
|Type|`Smartphone`
|Memory Card Slot|`No`
|Shockproof|`No`
|Waterproof|`Yes`
...
|Front Camera|`Yes`
|Resolution of Front Camera|7 MP
...
|Run Time in Idle Mode|384 h
|Battery Mount Type|`Integrated`
|Speaking Run Time|21 h
|Type of Battery|`Li-Ion`
|Additional Battery Capacity|
|Audio Playback Run Time|60 h
