...
|Front Camera|`true`
|Resolution of Front Camera|4 MegaPixels
...
|--------|-------|
|RAM|2 GB
|Memory Card Maximum Capacity|2000 GB
|CPU Cores|8
|CPU Model|`MediaTek Helio X10 (MT6795)`
|CPU Clock Rate|2000 MHz
|Graphics Processor Unit|`PowerVR G6200`
# Battery & Charging
|Property| Value |
|--------|-------|
|Battery Capacity|2840 mAh
|Fast Charging Standard|
|Run Time in Idle Mode|658 h
|Battery Mount Type|
