...
|--------|-------|
|Rear Camera|`true`
|Camera Resolution|21 MegaPixels
|Number of Rear Cameras|1
|Autofocus|`true`
|Flash|`Rear Flash`
|Flash Type|`LED Flash`
|Front Camera|`true`
|Resolution of Front Camera|5 MegaPixels;4 MegaPixels
|Optical Stabilization|`false` `true`
...
|Wi-Fi Standard Version|802.11ac;802.11n
|LTE Advanced Speed|
|GPS|`true`
|4G LTE|`true`
|NFC|`true`
...
|CPU Cores|8
|CPU Model|`Qualcomm Snapdragon 810 MSM8994`
|CPU Clock Rate|2200 MHz;2000 MHz
|Graphics Processor Unit|`Adreno 430`
# Battery & Charging
|Property| Value |
|--------|-------|
