...
|CPU Cores|8
|CPU Model|`Qualcomm Snapdragon 630` `Qualcomm Snapdragon 430 MSM8937`
|CPU Clock Rate|
|Graphics Processor Unit|`Adreno 508` `Adreno 505`
# Battery & Charging
|Property| Value |
|--------|-------|
|Battery Capacity|3300 mAh
|Fast Charging Standard|
|Run Time in Idle Mode|576 h
|Battery Mount Type|
|Speaking Run Time|30 h
|Type of Battery|
|Additional Battery Capacity|
|Audio Playback Run Time|96 h
