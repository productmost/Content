...
|Operating System Version|`Android 10 без сервисов Google`
|Form Factor|`Phablet`
|Width|73.1 mm
|Height|158.1 mm
|Depth|9.3 mm
...
|Front Camera|`true`
|Resolution of Front Camera|32 MegaPixels
...
|Glonass|`true`
|Bluetooth Standard Version|5.1
...
|CPU Cores|8
|CPU Model|`HiSilicon Kirin 990 5G`
|CPU Clock Rate|
|Graphics Processor Unit|`Mali-G76 MP16`
# Battery & Charging
|Property| Value |
|--------|-------|
